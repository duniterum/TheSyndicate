// src/routes/labs.tsx — hidden quarantine index. noindex; never linked from
// production navigation; excluded from sitemap; disallowed in robots.txt.
//
...
export const Route = createFileRoute("/labs")({
  head: () => ({
    meta: [
      { title: "Labs · Internal Archive — The Syndicate" },
