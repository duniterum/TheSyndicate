...
describe("production coherence guards", () => {
  ...
  it("keeps referral/source attribution readiness non-live and source-record gated", () => {
    ...
    expect(internalSourceFounderInputs).toContain("Source wallet: founder-provided controlled source wallet");
    expect(internalSourceFounderInputs).toContain("Payout wallet: same founder-provided controlled source wallet unless founder");
    expect(internalSourceFounderInputs).toContain("Exact Founder Questions");
    expect(internalSourceFounderInputs).toContain("Which public wallet should be the internal source wallet?");
