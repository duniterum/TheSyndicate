...
describe("Verified Introduction V1 buyer experience skeleton", () => {
  ...
  it("is not mounted into public join and does not create public route surfaces", () => {
    ...
    expect(reviewRouteSource).toContain("VERIFIED_INTRODUCTION_V1_DISCLOSURE_REVIEW");
    expect(reviewRouteSource).toContain("Buyer Disclosure / Accounting Review");
    expect(reviewRouteSource).toContain("Draft review - not legal or launch approval");
