  ...
  const groups: Array<{
  ...
  }> = [
    {
      ...
      items: [
        ...
        "Your capital-footprint band reflects verified USDC routed through receipts.",
        "Your contribution depth is visible from on-chain purchase proof.",
    ...
    },
    {
      ...
      items: [
        ...
        "Richer member profile pages with contribution history and wallet-level protocol receipts.",
