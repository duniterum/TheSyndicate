...
const ENTRIES: Entry[] = [
  ...
  { cat: "Archive", q: "Are Archive Artifacts NFTs?", a: "Yes — Archive Artifacts are ERC-1155 NFTs on Avalanche, served by the deployed SyndicateArchive1155 contract. ID 1 is publicly mintable today; ID 3 is contract/read gated; other IDs are owner-only, sealed, reserved, or pending a separate future contract." },
  ...
  { cat: "Archive", q: "What is a Seat Record?", a: "A Seat Record is the planned optional identity record for a verified Membership Sale purchase, encoding member number, chapter, and block height. It lives in a separate future ERC-721 contract (SyndicateSeatRecord721) — not in Archive1155, and not yet deployed." },
