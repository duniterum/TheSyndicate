  ...
  return (
    ...
    >
      ...
      <p className="text-muted-foreground leading-relaxed">
        Public read-only preview.{surface ? ` ${surface.publicSummary}` : ""} Values are simulated
        for the prototype and are not live. No wallet connection is required to view this page.
      </p>
    </div>
  );
}
