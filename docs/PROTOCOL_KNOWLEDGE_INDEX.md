...
| Public source/referral product decision | DIRECTION APPROVED / LAUNCH NOT APPROVED. Verified Introduction V1 is approved as the next Source Attribution product direction, the non-activating buyer skeleton has an internal noindex review surface, a launch-packet draft names the remaining gates, and anti-abuse/source eligibility, buyer disclosure/legal-accounting, and current-authority/release QA now have draft review models. Public source links, aliases, source dashboards, claim UI, and public source-aware buys still require a separate founder-approved launch packet. | `src/lib/public-product-decision-gate.ts`, `src/lib/source-public-product-framework.ts`, `src/lib/verified-introduction-v1-execution.ts`, `src/lib/verified-introduction-v1-buyer-experience.ts`, `src/lib/verified-introduction-v1-launch-packet.ts`, `src/lib/verified-introduction-v1-anti-abuse.ts`, `src/lib/verified-introduction-v1-disclosure.ts`, `src/lib/verified-introduction-v1-release-qa.ts`, `src/components/syndicate/VerifiedIntroductionBuyerExperience.tsx`, `src/routes/labs.verified-introduction-review.tsx`, `docs/SOURCE_PUBLIC_PRODUCT_DECISION_GATE.md`, `docs/SOURCE_PUBLIC_PRODUCT_DECISION_FRAMEWORK.md`, `docs/SOURCE_PUBLIC_PRODUCT_FOUNDER_REVIEW_PACKET.md`, `docs/VERIFIED_INTRODUCTION_V1_EXECUTION_BRIDGE.md`, `docs/VERIFIED_INTRODUCTION_V1_LAUNCH_PACKET_DRAFT.md` |
...
| Public product decision | Product/legal/UX/security/release gates, `src/lib/public-product-decision-gate.ts`, `src/lib/source-public-product-framework.ts`, `src/lib/verified-introduction-v1-execution.ts`, and `src/lib/verified-introduction-v1-release-qa.ts` | Users may be allowed to act only if separately approved. Verified Introduction V1 is approved as direction, not launch. | Backfilling activation from proof, memory, Chronicle, framework text, or direction approval alone. |
...
| 17 | Verified Introduction Founder Launch-Decision Assembly | Next: review the internal surface and all draft models together, then approve, revise, defer, or reject public launch posture. | Order 16. | Do not treat draft release QA as launch approval. |
| 18 | SeatRecord721 / ERC721 Identity | Next priority after Verified Introduction reaches safe implementation or launch-decision boundary. | Verified Introduction order 17/launch decision boundary. | Do not start identity work to avoid finishing Verified Introduction. |
| 19 | NFT / Archive Evolution | Priority after SeatRecord721 / ERC721 identity unless a verified dependency changes the order. | ERC721 identity work. | Do not make Archive/NFT source-aware by implication. |
| 20 | Whole-Protocol Continuous Excellence | Keep surfaces, docs, tests, status labels, and proof paths clean while referral matures. | Current GitHub truth. | Do not start unrelated future modules as fake-live placeholders. |
