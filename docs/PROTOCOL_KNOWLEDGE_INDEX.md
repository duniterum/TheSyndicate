...
| Public source/referral product decision | DIRECTION APPROVED / LAUNCH NOT APPROVED. Verified Introduction V1 is approved as the next Source Attribution product direction, the non-activating buyer skeleton has an internal noindex review surface, a launch-packet draft names the remaining gates, and anti-abuse/source eligibility, buyer disclosure/legal-accounting, current-authority/release QA, and final founder launch-decision assembly now have draft review models. Public source links, aliases, source dashboards, claim UI, and public source-aware buys still require a separate founder-selected launch decision and later approval. | `src/lib/public-product-decision-gate.ts`, `src/lib/source-public-product-framework.ts`, `src/lib/verified-introduction-v1-execution.ts`, `src/lib/verified-introduction-v1-buyer-experience.ts`, `src/lib/verified-introduction-v1-launch-packet.ts`, `src/lib/verified-introduction-v1-anti-abuse.ts`, `src/lib/verified-introduction-v1-disclosure.ts`, `src/lib/verified-introduction-v1-release-qa.ts`, `src/lib/verified-introduction-v1-founder-launch-decision.ts`, `src/components/syndicate/VerifiedIntroductionBuyerExperience.tsx`, `src/routes/labs.verified-introduction-review.tsx`, `docs/SOURCE_PUBLIC_PRODUCT_DECISION_GATE.md`, `docs/SOURCE_PUBLIC_PRODUCT_DECISION_FRAMEWORK.md`, `docs/SOURCE_PUBLIC_PRODUCT_FOUNDER_REVIEW_PACKET.md`, `docs/VERIFIED_INTRODUCTION_V1_EXECUTION_BRIDGE.md`, `docs/VERIFIED_INTRODUCTION_V1_LAUNCH_PACKET_DRAFT.md`, `docs/VERIFIED_INTRODUCTION_V1_FOUNDER_LAUNCH_DECISION_PACKET.md` |
...
| Referral / Source Attribution | INACTIVE public product; one internal real-condition source-attributed V3 receipt has been validated under staged guardrails. Verified Introduction V1 is approved as direction only; non-activating buyer preview, clear-source, failure-state infrastructure, internal review route, launch-packet draft, anti-abuse/source eligibility model, disclosure/legal-accounting model, current-authority/release QA model, and founder launch-decision packet now exist behind tests. | `docs/REFERRAL_SOURCE_ATTRIBUTION_V1_READINESS.md`, `docs/SOURCE_ATTRIBUTION_CAPABILITY_MAP.md`, `docs/SOURCE_PUBLIC_PRODUCT_DECISION_FRAMEWORK.md`, `docs/VERIFIED_INTRODUCTION_V1_EXECUTION_BRIDGE.md`, `docs/VERIFIED_INTRODUCTION_V1_LAUNCH_PACKET_DRAFT.md`, `docs/VERIFIED_INTRODUCTION_V1_FOUNDER_LAUNCH_DECISION_PACKET.md`, source packet docs | `src/routes/referral.tsx`, `src/routes/labs.verified-introduction-review.tsx`, `src/lib/source-attributed-receipts.ts`, `src/lib/future-referral.ts`, `src/lib/source-real-condition-test.ts`, `src/lib/source-public-product-framework.ts`, `src/lib/verified-introduction-v1-execution.ts`, `src/lib/verified-introduction-v1-buyer-experience.ts`, `src/lib/verified-introduction-v1-launch-packet.ts`, `src/lib/verified-introduction-v1-anti-abuse.ts`, `src/lib/verified-introduction-v1-disclosure.ts`, `src/lib/verified-introduction-v1-release-qa.ts`, `src/lib/verified-introduction-v1-founder-launch-decision.ts`, `src/components/syndicate/VerifiedIntroductionBuyerExperience.tsx` | source receipt tests, source lifecycle tests, public product framework tests, Verified Introduction execution/buyer-experience/launch-packet/anti-abuse/disclosure/release-QA/founder-decision tests, production coherence guards | Founder chooses approve launch-candidate preparation only, approve with revisions, defer public product, or reject V1 posture. | Claim UI, public links, aliases, source dashboard, product-wide attribution, or MLM-style language before launch approval. |
...
| Public product decision | Product/legal/UX/security/release gates, `src/lib/public-product-decision-gate.ts`, `src/lib/source-public-product-framework.ts`, `src/lib/verified-introduction-v1-execution.ts`, `src/lib/verified-introduction-v1-release-qa.ts`, and `src/lib/verified-introduction-v1-founder-launch-decision.ts` | Users may be allowed to act only if separately approved. Verified Introduction V1 is approved as direction, not launch; the founder decision packet now asks for approve-preparation, revise, defer, or reject. | Backfilling activation from proof, memory, Chronicle, framework text, direction approval, or decision-packet readiness alone. |
...
7. `docs/VERIFIED_INTRODUCTION_V1_EXECUTION_BRIDGE.md`
8. `src/lib/public-product-decision-gate.ts`
9. `src/lib/source-public-product-framework.ts`
10. `src/lib/verified-introduction-v1-execution.ts`
11. `docs/SOURCE_REAL_CONDITION_CEREMONY_READBACK.md`
12. `docs/SOURCE_PACKETS/SOURCE_PACKET_INTERNAL_TEST_001_DRAFT.md`
13. `src/lib/source-policy-observability.ts`
14. `src/lib/source-registry-lifecycle.ts`
15. `src/lib/source-attributed-receipts.ts`
16. `src/lib/source-real-condition-test.ts`
17. `src/lib/source-activation-readiness.ts`
18. `docs/SOURCE_ACTIVATION_READINESS_PACKET.md`
19. `src/lib/source-aware-test-mode.ts`
20. `docs/SOURCE_AWARE_LOCAL_TEST_PATH.md`
21. `src/lib/verified-introduction-v1-release-qa.ts`
22. `docs/VERIFIED_INTRODUCTION_V1_FOUNDER_LAUNCH_DECISION_PACKET.md`
23. `src/lib/verified-introduction-v1-founder-launch-decision.ts`
...
| 8 | Public Source Product Framework | Completed as the approved direction: invite-only Verified Introduction V1, MembershipSaleV3-only, manual approval, buyer-visible, buyer-clearable, direct-payout-first, and no aliases, claim UI, source dashboard, open self-serve referral, or product-wide attribution. | Gate from order 7. | Do not treat direction approval as launch approval. |
| 9 | Public Source Product Founder Review Packet | Completed as the non-technical decision record. Option A - approve as direction - is selected. | Framework from order 8. | Do not treat the review packet as public source-link authority. |
| 10 | Verified Introduction Execution Bridge | Completed as the bridge from approved direction to non-activating implementation. | Founder direction decision. | Do not activate, publish user-actionable controls, create aliases, or create claim UI. |
| 11 | Non-Activating Verified Introduction Skeleton | Completed as buyer preview, clear-source, and failure-state models/components behind tests only. | Execution bridge. | Do not add navigation, sitemap entries, public source links, or non-zero default `/join`. |
| 12 | Verified Introduction Internal Review Surface | Completed as a direct-URL, noindex `/labs/verified-introduction-review` surface with exact review query and no wallet controls. | Order 11. | Do not treat reviewability as launch approval or public route authority. |
| 13 | Verified Introduction Launch-Packet Boundary | Completed as a draft boundary naming remaining founder, eligibility, disclosure, legal/accounting, readback, release-QA, and exclusion gates; launch remains unapproved. | Order 12. | Do not treat a draft launch packet as approval. |
| 14 | Verified Introduction Anti-Abuse / Source Eligibility Review | Completed as a draft review model displayed on the hidden internal surface; source eligibility and abuse states fail closed before signature. | Order 13. | Do not treat source eligibility draft review as source approval. |
| 15 | Verified Introduction Disclosure / Legal-Accounting Review | Completed as a draft review model displayed on the hidden internal surface; accounting labels, required before-signature copy, forbidden copy, and stop conditions now fail closed before signature. | Order 14. | Do not treat disclosure draft review as legal/accounting signoff or launch approval. |
| 16 | Verified Introduction Current-Authority / Release QA Packet | Completed as a draft release-QA model displayed on the hidden internal surface; latest-chain reads, Replit gates, live QA, no-leakage checks, and stop conditions are defined. Actual readbacks and launch approval remain pending. | Order 15. | Do not publish user-actionable controls without separate founder approval. |
| 17 | Verified Introduction Founder Launch-Decision Assembly | Completed as a founder-facing decision packet and machine-readable model on the hidden review surface. It asks the founder to approve launch-candidate preparation only, approve with revisions, defer public product, or reject the V1 posture. | Order 16. | Do not treat decision-packet readiness as launch approval. |
| 18 | Verified Introduction Founder Decision | Next: founder chooses approve-preparation, revise, defer, or reject. | Order 17. | Do not prepare public controls until a clear founder decision selects the next path. |
| 19 | SeatRecord721 / ERC721 Identity | Next priority after Verified Introduction reaches safe implementation or launch-decision boundary. | Verified Introduction order 18/founder decision boundary. | Do not start identity work to avoid finishing Verified Introduction. |
| 20 | NFT / Archive Evolution | Priority after SeatRecord721 / ERC721 identity unless a verified dependency changes the order. | ERC721 identity work. | Do not make Archive/NFT source-aware by implication. |
| 21 | Whole-Protocol Continuous Excellence | Keep surfaces, docs, tests, status labels, and proof paths clean while referral matures. | Current GitHub truth. | Do not start unrelated future modules as fake-live placeholders. |
...
- `src/lib/__tests__/verified-introduction-v1-execution.test.ts` - direction-approved/non-launch execution bridge, priority order, buyer-preview requirements, failure states, and launch blockers.
- `src/lib/__tests__/verified-introduction-v1-buyer-experience.test.ts` - non-activating buyer preview, clear-source fallback, approval-vs-buy separation, failure states, internal review-route gate, and no public route/source path leakage.
- `src/lib/__tests__/verified-introduction-v1-launch-packet.test.ts` - launch packet draft boundary, pending approvals, blocked excluded surfaces, and no public-control approval.
- `src/lib/__tests__/verified-introduction-v1-anti-abuse.test.ts` - source eligibility, abuse states, fail-closed behavior, and no public-control approval.
- `src/lib/__tests__/verified-introduction-v1-disclosure.test.ts` - buyer disclosure, accounting labels, forbidden copy, before-signature requirements, and no public-control approval.
- `src/lib/__tests__/verified-introduction-v1-release-qa.test.ts` - latest-chain reads, Replit/live QA gates, no-leakage checks, stop conditions, and no public-control approval.
- `src/lib/__tests__/verified-introduction-v1-founder-launch-decision.test.ts` - founder launch-decision packet, approve/revise/defer/reject options, unresolved decision gates, and no public-control approval.
