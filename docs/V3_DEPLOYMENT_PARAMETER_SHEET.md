...
- no source activation, referral UI, or claim UI until separately approved.
...
16. Keep no source activation, public source path, or additional source records unless separately approved.
