...
- `docs/SOURCE_PUBLIC_PRODUCT_DECISION_GATE.md` - operational proof-to-public-product gate for Source Attribution after the first completed internal lifecycle. It records that public source/referral product is not approved until scope, UX, anti-abuse, disclosure, release QA, and founder approval gates are satisfied. It has no deployment, publish, transaction, source activation, referral activation, public-source-link, source-dashboard, public source-aware-buy-path, or claim-UI authority.
- `docs/SOURCE_PUBLIC_PRODUCT_DECISION_FRAMEWORK.md` - operational decision framework for whether Source Attribution should become a public product and what the approved V1 direction is. Verified Introduction V1 is direction-approved as MembershipSaleV3-only, manually approved, buyer-visible, buyer-clearable, direct-payout-first, and without aliases, claim UI, source dashboard, or product-wide attribution. It has no deployment, publish, transaction, source activation, referral activation, public-source-link, alias route, source-dashboard, public source-aware-buy-path, or claim-UI authority.
- `docs/SOURCE_PUBLIC_PRODUCT_FOUNDER_REVIEW_PACKET.md` - operational founder-review record for the approved-direction decision on Verified Introduction V1. It records that launch remains unapproved and has no deployment, publish, transaction, source activation, referral activation, public-source-link, alias route, source-dashboard, public source-aware-buy-path, or claim-UI authority.
- `docs/VERIFIED_INTRODUCTION_V1_EXECUTION_BRIDGE.md` - operational execution bridge from direction-approved Verified Introduction V1 to non-activating implementation work. It defines phases, launch blockers, readbacks, Replit posture, the non-activating buyer skeleton, the noindex internal review surface, and the founder priority order Verified Introduction -> SeatRecord721/ERC721 -> NFT/Archive. It has no deployment, publish, transaction, source activation, referral activation, public-source-link, alias route, source-dashboard, public source-aware-buy-path, or claim-UI authority.
- `docs/VERIFIED_INTRODUCTION_V1_LAUNCH_PACKET_DRAFT.md` - operational launch-decision draft for Verified Introduction V1. It records the remaining founder, source-eligibility, buyer-disclosure, legal/accounting, readback, release-QA, and exclusion gates before any user-actionable public controls can exist. It has no deployment, publish, transaction, source activation, referral activation, public-source-link, alias route, source-dashboard, public source-aware-buy-path, or claim-UI authority.
- `docs/VERIFIED_INTRODUCTION_V1_FOUNDER_LAUNCH_DECISION_PACKET.md` - operational founder decision packet for Verified Introduction V1. It assembles the execution bridge, launch-packet draft, anti-abuse/source eligibility review, disclosure/legal-accounting review, and release-QA review into approve-preparation/revise/defer/reject options. It has no deployment, publish, transaction, source activation, referral activation, public-source-link, alias route, source-dashboard, public source-aware-buy-path, claim-UI, or launch authority.
