...
| # | Collision | Ruling |
|---|---|---|
| 1 | **Patron (reserved for support)** | **RESOLVED (Sprint A.7).** The $500 rank was renamed **Steward**. "Patron" is now reserved for the **support family only** — Patron Seal (Archive1155 ID 3, 5.00 USDC), Patron Support, Patron Actions, Patron Recognition. No rank uses "Patron." |
| 2 | **Council (reserved for governance)** | **RESOLVED (Sprint A.7).** The $2,500 rank was renamed **Keystone** and the $1,000 "Council Candidate" rank renamed **Custodian**. "Council" is now reserved for a future governance body only (e.g. "Governance Council"); no rank uses it. Rank still confers no governance. |
