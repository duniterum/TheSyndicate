...
| Membership sale V2b | `MEMBERSHIP_SALE_V2_CONTRACT_ADDRESS`, historical scanners | SyndicateMembershipSale V2b | `SYNDICATE_PROTOCOL_MODEL.md`, `SMART_CONTRACT_SYSTEM_MAP.md`, `V3_NON_LIVE_DEPLOYMENT_READBACK_LOG.md` | PAUSED ON-CHAIN / HISTORICAL ONLY | High | Med (must not be treated as current buy target) |
| V3 SourceRegistry | `SOURCE_REGISTRY_V1_CONTRACT_ADDRESS`, `contract-registry.ts`, `source-policy-observability.ts`, `source-real-condition-test.ts` | SourceRegistryV1 `0x780013bB358be6be95b401901264FC7c22a595a6` | `SOURCE_REAL_CONDITION_CEREMONY_READBACK.md`, `V3_NON_LIVE_DEPLOYMENT_READBACK_LOG.md`, `V3_PROTOCOL_ENGINE_CONSTITUTION.md` | DEPLOYED / ONE INTERNAL SOURCE RE-PAUSED AFTER VALIDATED TEST / REFERRAL UI INACTIVE | High | High (must not be treated as live source/referral UI) |
| V3 MembershipSale | `MEMBERSHIP_SALE_V3_CONTRACT_ADDRESS`, sale hooks, `LivePurchase.tsx` | MembershipSaleV3 `0x2A6cFc76906e758B934209AFf5A163c9bC20132E` | `V3_NON_LIVE_DEPLOYMENT_READBACK_LOG.md`, `V3_PROTOCOL_ENGINE_CONSTITUTION.md`, `V3_DEPLOYMENT_READINESS_PACKAGE.md` | DEPLOYED / OWNER ACCEPTED / FUNDED / CURRENT FRONTEND BUY TARGET / ZERO SOURCE ID | High | Med (source/referral terms remain inactive) |
...
| Referral / Source attribution | `source-policy-observability.ts`, `source-real-condition-test.ts`, `future-referral.ts`, `preview/referral.ts`, deployed SourceRegistryV1 docs | SourceRegistryV1 `0x780013bB358be6be95b401901264FC7c22a595a6`; deployed; one internal source record; one validated internal source-attributed V3 receipt; final status PAUSED; not public-frontend-wired | `SOURCE_REAL_CONDITION_CEREMONY_READBACK.md`, `IDENTITY_ATTRIBUTION_CONSTITUTION.md`, `V3_PROTOCOL_ENGINE_CONSTITUTION.md`, `REVENUE_ATTRIBUTION_LAYER.md` | VALIDATED INTERNAL SOURCE TEST / PUBLIC REFERRAL UI PENDING | Med | High (must not imply source owns member or referral is live) |
...
| Membership Sale V2b (paused historical source) | `0x507E9c9C365a865F2A2b94DA9E12ccCC2bBeB88b` (paused on-chain by tx `0x74ccaa2fb80c266a54f57387021cc5ff634c0853f396b4a12d2654b64a05fede`; retained for history and recovery boundary) |
| V3 SourceRegistry | `0x780013bB358be6be95b401901264FC7c22a595a6` (deployed; owner accepted; one internal source record; one validated internal source-attributed buy; final status PAUSED; referral/source UI inactive) |
| V3 MembershipSale | `0x2A6cFc76906e758B934209AFf5A163c9bC20132E` (current frontend buy target; funded with 7,000,000 SYN by tx `0x04b3baf507d2908bff3b561207407cd12d8469a5785bcf90cd4dccaaea5cb7e2`; public buys use zero sourceId) |
