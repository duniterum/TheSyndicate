...
| Referral / Source attribution | `source-policy-observability.ts`, `future-referral.ts`, `preview/referral.ts`, deployed SourceRegistryV1 docs | SourceRegistryV1 `0x780013bB358be6be95b401901264FC7c22a595a6`; deployed; one internal PAUSED source record; not frontend-wired | `IDENTITY_ATTRIBUTION_CONSTITUTION.md`, `V3_PROTOCOL_ENGINE_CONSTITUTION.md`, `REVENUE_ATTRIBUTION_LAYER.md`, `V3_NON_LIVE_DEPLOYMENT_READBACK_LOG.md` | PAUSED INTERNAL SOURCE / REFERRAL UI PENDING | Med | High (must not imply source owns member or referral is live) |
...
| V3 SourceRegistry | `0x780013bB358be6be95b401901264FC7c22a595a6` (deployed; owner accepted; one internal PAUSED source record; referral/source UI inactive) |
